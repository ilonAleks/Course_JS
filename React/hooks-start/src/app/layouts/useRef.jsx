        ...
        <>
            ...
            <CollapseWrapper>
                <BlockQuote>
                    ...
                    <p>
                        <i>
                            В этом ролике мы разберемся с хуком useRef. В нем
                            можно сохранять любое значение и хранить/изменять
                            его в течение всей жизни компонента. При изменении
                            значения не произойдет повторный рендер.
                        </i>
                    </p>
                </BlockQuote>
            </CollapseWrapper>
